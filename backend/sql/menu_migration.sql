...
VALUES (13, '知识库管理', 'knowledge', 0, '/knowledge', 'Layout', 'carbon-knowledge-app', 1, 1, 1, 2, NOW(), NOW(), 0);
...
-- 简历上传页面（隐藏菜单，不在菜单中显示）
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_code`, `parent_id`, `path`, `component`, `icon`, `menu_type`, `visible`, `status`, `sort`, `create_time`, `update_time`, `deleted`)
VALUES (17, '简历上传', 'resume-upload', 2, '/resume/upload', 'resume/Upload', NULL, 2, 0, 1, 1, NOW(), NOW(), 0);

-- 简历详情页面（隐藏菜单，不在菜单中显示）
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_code`, `parent_id`, `path`, `component`, `icon`, `menu_type`, `visible`, `status`, `sort`, `create_time`, `update_time`, `deleted`)
VALUES (18, '简历详情', 'resume-detail', 2, '/resume/:id', 'resume/Detail', NULL, 2, 0, 1, 2, NOW(), NOW(), 0);

-- 面试会话页面（隐藏菜单，不在菜单中显示）
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_code`, `parent_id`, `path`, `component`, `icon`, `menu_type`, `visible`, `status`, `sort`, `create_time`, `update_time`, `deleted`)
VALUES (19, '面试会话', 'interview-session', 4, '/interview/session/:id', 'interview/Session', NULL, 2, 0, 1, 1, NOW(), NOW(), 0);
