...
import com.daliymove.admin.dto.PermissionDTO;
import com.daliymove.admin.service.PermissionService;
import com.daliymove.admin.vo.PermissionVO;
...
public class PermissionController {
    ...
    @Log("新增权限")
    @PostMapping
    public Result<Void> save(@RequestBody PermissionDTO dto) {
